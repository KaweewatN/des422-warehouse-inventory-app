...
const ListItemTable = () => {
  ...
  return (
    <Stack width="full" gap="5" marginTop="2rem">
      <Heading size="xl">All itemss</Heading>

      <Table.Root size="sm" variant="outline" interactive>
        <Table.Header bg="#EAECF0">
          <Table.Row>
            <Table.ColumnHeader color="black">ID</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Item name</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Description</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Item type</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Quantity</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Sku</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Created by</Table.ColumnHeader>
            <Table.ColumnHeader color="black">Item image</Table.ColumnHeader>
          </Table.Row>
        </Table.Header>
